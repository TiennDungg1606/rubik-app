...
export default function AuthForm() {
  ...
  return (
    <div className="w-full max-w-md mx-auto bg-white/90 rounded-2xl shadow-2xl px-8 py-10 flex flex-col items-center border border-gray-200 relative">
      {/* Logo */}
      ...
      <div className="flex w-full mb-6">
        <button
          className={`flex-1 py-2 font-bold rounded-l-xl transition-all duration-150 ${tab === "login" ? "bg-blue-600 text-white shadow" : "bg-gray-100 text-gray-700"}`}
          onClick={() => setTab("login")}
        >Sign in</button>
        <button
          className={`flex-1 py-2 font-bold rounded-r-xl transition-all duration-150 ${tab === "register" ? "bg-blue-600 text-white shadow" : "bg-gray-100 text-gray-700"}`}
      ...
      <div className="flex justify-between w-full mt-4 text-sm">
        <a href="#" className="text-blue-600 hover:underline">Don't have an account?</a>
